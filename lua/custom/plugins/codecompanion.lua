...
return {
  ...
  keys = {
    { '<leader>ca', '<cmd>CodeCompanionActions<CR>', mode = { 'n', 'v' }, desc = 'Open [C]odeCompanion [A]ction palette' },
    { '<leader>cc', '<cmd>CodeCompanionChat Toggle<CR>', mode = { 'n', 'v' }, desc = 'Open [C]odeCompanion [C]hat panel' },
    { '<leader>ci', ':CodeCompanion', mode = { 'n', 'v' }, desc = 'Open [C]odeCompanion [I]nline assistant' },
  },
}
